...
def eiras(filename1,filename2):
    ...
    #plt.show() 
    plt.savefig('C:/Users/mjdee/Desktop/JI-2020/ML/the_roc_mimic.jpg', bbox_inches='tight',dpi=600)
    plt.close()  
    ...
    plt.tight_layout()
    plt.savefig('C:/Users/mjdee/Desktop/JI-2020/ML/the_calibration_mimic.jpg', bbox_inches='tight',dpi=600)
    plt.show()
...
if __name__ == '__main__':
    filepath = ["C:/Users/mjdee/Desktop/JI-2020/ML/PUTH_SHENZHEN.csv","C:/Users/mjdee/Desktop/JI-2020/ML/mimic_baseline.csv"]
    ...
    df.to_csv("C:/Users/mjdee/Desktop/JI-2020/ML/tableMIMIC.csv",encoding='GBK')
